...
export default function Video() {
    const videos = [
        {vid:"KVpxP3ZZtAc", img:"/videos/1.jpg"},
        {vid:"T7aNSRoDCmg", img:"/videos/2.jpg"},
        {vid:"k9Jn0eP-ZVg", img:"/videos/3.jpg"},
        {vid:"SfAoGd8R-CM", img:"/videos/4.jpg"}
    ]
    ...
    return (
        <div className=" w-screen bg-red-100 bg-opacity-50 inset-0 px-5 py-10 mx-auto text-left ">
            ...
            <p className="mt-2 mb-10 md:w-2/3 lg:w-1/2 sm:w-full text-custom-muted">Here are some video tutorials for self-defense.</p>
